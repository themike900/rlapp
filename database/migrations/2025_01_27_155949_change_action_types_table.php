...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('action_types')->insert([
            ['order' => 1, 'name' => 'Vereinsfahrt',           'sc' => 'vf',  'web_list' => 'sl', 'groups' => '{"cr": 6, "se": 2, "mf": 25}'],
            ['order' => 2, 'name' => 'Ausbildungsfahrt',       'sc' => 'af',  'web_list' => 'sl', 'groups' => '{"cr": 15}'],
            ['order' => 3, 'name' => 'Gästefahrt extern',      'sc' => 'gfx', 'web_list' => 'gl', 'groups' => '{"cr": 10, "se": 2}'],
            ['order' => 4, 'name' => 'Gästefahrt Mitglied',    'sc' => 'gfm', 'web_list' => 'gl', 'groups' => '{"cr": 10, "se": 2}'],
