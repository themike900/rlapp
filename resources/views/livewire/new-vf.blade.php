<form wire:submit="submit" class="space-y-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md border">
            <h3 class="text-base font-semibold text-gray-700 mb-4">Vereinsfahrt</h3>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md border">
            ...
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="checkbox" id="with_wl" value="1" wire:model.defer="ac_with_wl" class="mr-2">
