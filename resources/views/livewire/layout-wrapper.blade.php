<div class="flex h-fit">
    <!-- Sidebar -->
    <div class="w-56 bg-blue-700 h-screen px-2 py-4">
            ...
            @foreach ([
                ...
                <li>
                    <a href="#"
                       ...
                       class="block px-1 rounded-md hover:bg-blue-900 no-underline {{ $currentPage === $item['route'] ? 'bg-white text-blue-900' : 'bg-blue-700 text-white' }}"
