<form wire:submit="submit" class="space-y-2">
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md border">
            ...
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <input type="number" min="0" max="20" wire:model="ac_max_guests"
                           class="mt-1 px-2 py-1 block w-full rounded-md border shadow-sm hover:bg-gray-100focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700">Warteliste</label>

                    <div class="mt-1">
                        <input type="checkbox" id="with_wl" value="1" wire:model="ac_with_wl" class="mr-2">
                        <label for="with_wl" class="text-sm text-gray-700">mit Warteliste für Teilnehmer</label>
                    </div>
                </div>
            </div>
    ...
    <div class="pt-4">
        <button type="button" wire:click="save" wire:confirm="Änderung speichern?"
