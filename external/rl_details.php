...
function rl_details() {
    ...
    ?>
    <p style="text-align: right"><a href="<?php echo $list_path; ?>?id=<?php echo $actionId?>">zurück zur Segeltermin-Liste</a></p>
    ...
    <table style="width:100%; border-collapse: collapse">
        ...
        <tr><td style="background-color: #b1d4fd"><b>Anmeldung</b></td></tr>
                    ...
                    <div style="display: flex; flex-direction: column; align-items: center">
                        <table style="width:90%; border-collapse: collapse; background-color: white">
                            <?php foreach ($anm as $a) { ?>
                                <?php  if ($a['guests'] == 0) { ?>
                                    <tr>
                                        <td style="text-align: right;"><b><?php echo $a['text'] ?></b></td>
                                        <td>
            ...
            <tr>
                <td style="background-color: #d6e8ff">
                    <div style="display: flex; flex-direction: column; align-items: center">
                        <table style="width:90%; border-collapse: collapse; background-color: white">
                            <tr>
                                <td style="vertical-align: top;">Du bist angemeldet als</td>
                                <td><b><?php echo $reg['name']?></b></td>
                            </tr>
                            <?php if ($reg['group'] == 'sf') { ?>
                                <tr>
                                    <td>Änderungen sind nur übr die Fahrtenplanung möglich</td>
                                    <td>&nbsp;</td>
                                </tr>
                            <?php } else { ?>
                                ...
                                <tr>
                                    <?php if ($reg['group'] == 'cr') { ?>
                                        <td>Die Planung ist noch nicht abgeschlossen,<br>deswegen kannst du dich bei Bedarf wieder abmelden</td>
                                    <?php } ?>
                                    <?php if ($reg['group'] == 'sv') { ?>
                                        <td>Du kannst dich wieder abmelden,<br>sorge bitte für eine neue Service-Kraft</td>
                                    <?php } ?>
                                    <?php if ($reg['group'] == 'mf') { ?>
                                        <td>Wenn du dich wieder abmeldest,<br>werden auch eventuelle Gäste mit abgemeldet</td>
                                    <?php } ?>
                                    <?php if ($reg['group'] == 'tn' or $reg['group'] == 'sh') { ?>
                                        <td>Abmeldung ist jederzeit möglich</td>
                                    <?php } ?>
                                    <td>
                                        <form action="https://rlapp.schummel.de/api/rlreg" method="POST">
                                            <input type="hidden" name="webid" value="<?php echo $webId?>">
